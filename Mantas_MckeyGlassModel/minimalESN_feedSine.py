...
# load the data
trainLen = 897 #trainLen=965(966)/1834/2230 gives the best result for fr=7 & N=100/200/300, time stamps are at dt=0.001 
testLen = 4000
initLen = 100
...
print('previous spectral radius: ', rhoW)
print('adjusted spectral radius: ', np.max(np.abs(LA.eig(W)[0])))
